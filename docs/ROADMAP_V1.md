...
**Date :** 7 août 2026 | **Repo :** Neltud/xArtists @ v0.15.0+
...
### Contexte (7 août 2026)
- **Mainnet v1.11.10.0 activé le 6 août** (epoch 2198) — améliorations VM.
...
*Maintenu par Neltud (@tudurioriginal) via Grok — 7 août 2026*
