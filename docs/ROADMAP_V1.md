...
**Date :** 16 août 2026 | **Repo :** Neltud/xArtists @ v0.15.0+
...
### Contexte (16 août 2026)
- **Mainnet v1.11.10.0 activé le 6 août** (epoch 2198) — améliorations VM. Réseau **stable J+10**.
- **Mainnet v1.11.11.0** sorti **10 août** — extra checks miniblocks (pas d’activation epoch). Réseau **stable J+6**.
...
*Mise à jour : 16 août 2026 — Neltud via Grok*
