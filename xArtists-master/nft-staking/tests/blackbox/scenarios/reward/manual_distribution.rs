use multiversx_sc_scenario::{imports::SetStateStep, rust_biguint, ExpectValue, ScenarioTxRun};
...
use crate::{
    ...
    config::{NFT_TOKEN_ID, REWARD_TOKEN_ID_1, REWARD_TOKEN_ID_2, SC_ADDRESS, USER_ADDRESS},
};
...
#[test]
fn manual_reward_distribution_should_update_last_distribution_round() {
    let mut world = setup_world_with_contract();

    world.set_state_step(SetStateStep::new().block_round(1));
    send_distribute_rewards_tx(&mut world, REWARD_TOKEN_ID_1, DEFAULT_NFT_SCORE);
    ...
    world
        ...
        .last_reward_rate_update(REWARD_TOKEN_ID_1)
    ...
    world
        ...
        .to(SC_ADDRESS)
        .typed(nft_staking::proxy::NftStakingProxy)
        .last_reward_rate_update(REWARD_TOKEN_ID_2)
