    ...
    Gas: TxGas<Env>,
{
    ...
    pub fn get_unstored_rewards_for_token<
        Arg0: ProxyArg<ManagedAddress<Env::Api>>,
        Arg1: ProxyArg<TokenIdentifier<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("getUnstoredRewardsForToken")
            .argument(&user)
    ...
    >(
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("getLastUserUpdate")
            .argument(&user)
            .original_result()
    }

    pub fn last_reward_rate_update<
        Arg0: ProxyArg<TokenIdentifier<Env::Api>>,
    >(
        self,
        reward_token_id: Arg0,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("getLastRewardRateUpdate")
            .argument(&reward_token_id)
            .original_result()
    }
